...
//
//     final mealDbResponse = mealDbResponseFromJson(jsonString);

import 'dart:convert';

MealDbResponse mealDbResponseFromJson(String str) =>
    MealDbResponse.fromJson(json.decode(str));

class MealDbResponse {
  final List<Meal>? meals;

  MealDbResponse({this.meals});

  factory MealDbResponse.fromJson(Map<String, dynamic> json) => MealDbResponse(
